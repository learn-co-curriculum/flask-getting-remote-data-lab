...
This project now includes a reusable GetRequester class that retrieves and parses remote JSON data.

Features:
• Initializes with a URL endpoint.
• Fetches data via HTTP GET request.
